...
2.1. Метода getSpeed() в классе Runner оказывает, сколько шагов в секунду делает бегун.
...
ВАЖНО! Используй метод Thread.sleep(), а не Task02_Stopwatch.sleep().
 */
public class Task02_Stopwatch {
